...
g.i.bar<-ggplot(data=dat.gorilla,aes(x=image,y=as.numeric(qinteract),fill=qinteract))+
  geom_bar(position="fill", stat="identity",width=0.6,show.legend=FALSE)+
  scale_fill_fish_d(option="Epibulus_insidiator",direction=-1,labels=c("Strongly disagree","Disagree","Neutral","Agree","Strongly agree"),
                                                               name="Category")+
...
g.e.bar<-ggplot(data=dat.gorilla,aes(x=image,y=as.numeric(qendangered),fill=qendangered))+
  geom_bar(position="fill", stat="identity",width=0.6,show.legend = FALSE)+
  scale_fill_fish_d(option="Epibulus_insidiator",direction=-1,labels=c("Strongly disagree","Disagree","Neutral","Agree","Strongly agree"),
                    name="Category")+
  ylab("Percentage of responses")+
...
g.hp.bar<-ggplot(data=dat.gorilla,aes(x=image,y=as.numeric(qhavepet),fill=qhavepet))+
  geom_bar(position="fill", stat="identity",width=0.6,show.legend = FALSE)+
  scale_fill_fish_d(option="Epibulus_insidiator",direction=-1,labels=c("Strongly disagree","Disagree","Neutral","Agree","Strongly agree"),
                    name="Category")+
  ylab("Percentage of responses")+
...
g.gp.bar<-ggplot(data=dat.gorilla,aes(x=image,y=as.numeric(qgoodpet),fill=qgoodpet))+
  geom_bar(position="fill", stat="identity",width=0.6,show.legend = FALSE)+
  scale_fill_fish_d(option="Epibulus_insidiator",direction=-1,labels=c("Strongly disagree","Disagree","Neutral","Agree","Strongly agree"),
                    name="Category")+
  ylab("Percentage of responses")+
...
l.i.bar<-ggplot(data=dat.loris,aes(x=image,y=as.numeric(qinteract),fill=qinteract))+
  geom_bar(position="fill", stat="identity",width=0.6,show.legend = FALSE)+
  scale_fill_fish_d(option="Epibulus_insidiator",direction=-1,labels=c("Strongly disagree","Disagree","Neutral","Agree","Strongly agree"),
                    name="Category")+
  ylab("Percentage of responses")+
...
l.e.bar<-ggplot(data=dat.loris,aes(x=image,y=as.numeric(qendangered),fill=qendangered))+
  geom_bar(position="fill", stat="identity",width=0.6,show.legend = FALSE)+
  scale_fill_fish_d(option="Epibulus_insidiator",direction=-1,labels=c("Strongly disagree","Disagree","Neutral","Agree","Strongly agree"),
                    name="Category")+
  ylab("Percentage of responses")+
...
l.hp.bar<-ggplot(data=dat.loris,aes(x=image,y=as.numeric(qhavepet),fill=qhavepet))+
  geom_bar(position="fill", stat="identity",width=0.6,show.legend=FALSE)+
  scale_fill_fish_d(option="Epibulus_insidiator",direction=-1,labels=c("Strongly disagree","Disagree","Neutral","Agree","Strongly agree"),
                    name="Category")+
  ylab("Percentage of responses")+
...
l.gp.bar<-ggplot(data=dat.loris,aes(x=image,y=as.numeric(qgoodpet),fill=qgoodpet))+
  geom_bar(position="fill", stat="identity",width=0.6,show.legend=FALSE)+
  scale_fill_fish_d(option="Epibulus_insidiator",direction=-1,labels=c("Strongly disagree","Disagree","Neutral","Agree","Strongly agree"),
                    name="Category")+
  ylab("Percentage of responses")+
